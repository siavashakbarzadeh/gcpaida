"""
Generate a Word document report (Farsi) for CGP city analysis results (2020).
"""
import os
import pandas as pd
...
def main():
    ...
    data_desc = (
        ...
        'این داده‌ها از فایل‌های CSV هر شهر استخراج و در یک فایل واحد (merged_cities_2020.csv) ادغام شده‌اند.'
    )
    ...
    output_path = os.path.join(OUTPUT_DIR, 'CGP_Report_Farsi_2020.docx')

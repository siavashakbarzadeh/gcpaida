"""
CGP (Cartesian Genetic Programming) - City Relationship Discovery (2020)
=========================================================================
...
Output: 2020/cgp_results/ folder with network graphs, heatmaps, and summaries.
"""
...
OUTPUT_DIR = r"c:\Users\Utente\Documents\GitHub\gcpaida\2020\cgp_results"
...
def plot_network_graph(connections, city_names, output_dir, top_n=50):
    ...
    ax.set_title('CGP-Discovered City Infection Network (2020)\n'
...
def plot_connection_heatmap(connection_matrix, city_names, output_dir):
    ...
    ax.set_title('CGP Connection Strength Heatmap (R² of prediction) - 2020', fontsize=14, fontweight='bold')
...
def plot_top_connections(connections, output_dir, top_n=40):
    ...
    ax.set_title(f'Top {top_n} Strongest City Connections (CGP) - 2020', fontsize=14, fontweight='bold')
...
def plot_hub_cities(city_connection_count, output_dir):
    ...
    ax.set_title('City Hub Analysis: Number of CGP-Discovered Connections (2020)',
...
def plot_cgp_fitness_examples(fitness_histories, output_dir, n_examples=6):
    ...
    for idx, city in enumerate(example_cities):
        ...
        ax.set_yscale('log')
    fig.suptitle('CGP Evolution Fitness Convergence (2020)', fontsize=14, fontweight='bold')
    plt.tight_layout()
...
def plot_city_influence_detail(target, active_cities, r2_scores, output_dir):
    ...
    ax.set_title(f'Cities Influencing {target.title()} (CGP) - 2020', fontsize=13, fontweight='bold')
    ax.grid(True, alpha=0.3, axis='x')
    ax.invert_yaxis()
    plt.tight_layout()
...
def plot_grouped_connections(connections, city_names, output_dir):
    ...
    ax.set_title('Top 30 Most Connected Cities - Connection Matrix (CGP R²) - 2020',
...
def main():
    print("=" * 70)
    print("   CGP - Cartesian Genetic Programming (2020)")
    ...
    print("\n" + "=" * 70)
    print("   CGP RESULTS SUMMARY (2020)")
    print("=" * 70)

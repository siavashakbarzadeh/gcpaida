"""
Generate an English Word document report for CGP city analysis results (2021).
"""
import os
import pandas as pd
...
def main():
    ...
    doc.add_paragraph(
        ...
        'using CGP on 2021 data from 107 provinces.')
    ...
    doc.add_paragraph('Daily cumulative infections for 107 provinces in 2021 (365 days), merged into merged_cities_2021.csv.')
    ...
    doc.add_paragraph(f'{n_sig} significant connections found among 107 cities in 2021 data.')
    ...
    path = os.path.join(OUTPUT_DIR, 'CGP_Report_English_2021.docx')
    doc.save(path)

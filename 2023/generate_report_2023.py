"""
Generate a Word document report (Farsi) for CGP city analysis results (2023).
"""
import os
import pandas as pd
...
CGP_DIR = r"c:\Users\Utente\Documents\GitHub\gcpaida\2023\cgp_results"
OUTPUT_DIR = r"c:\Users\Utente\Documents\GitHub\gcpaida\2023\reports"
...
def main():
    ...
    data_desc = (
        ...
        'این داده‌ها از فایل‌های CSV هر شهر استخراج و در یک فایل واحد (merged_cities_2023.csv) ادغام شده‌اند.'
    )
    ...
    output_path = os.path.join(OUTPUT_DIR, 'CGP_Report_Farsi_2023.docx')

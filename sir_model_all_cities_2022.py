"""
SIR Model for ALL 107 Italian Provinces - COVID-19 Data (2022)
===============================================================
Reads merged_cities_2022.csv and applies SIR compartmental model
to all 107 provinces. Results saved to sir-result-2022/ folder.
...
OUTPUT_DIR = r"c:\Users\Utente\Documents\GitHub\gcpaida\sir-result-2022"
os.makedirs(OUTPUT_DIR, exist_ok=True)

# Italian province populations (ISTAT 2022 approximate)
...
def plot_top_cities_comparison(all_results, dates, output_dir, top_n=10):
    ...
    fig.suptitle(f'SIR Model - Top {top_n} Cities by Total Cases (2022)', fontsize=16, fontweight='bold')
...
def plot_all_beta_heatmap(all_results, dates, output_dir):
    ...
    ax.set_title('Beta(t) Heatmap - All 107 Cities (2022)', fontsize=14, fontweight='bold')
    ax.set_xlabel('Month')
...
def main():
    print("=" * 70)
    print("   SIR Model - ALL 107 Italian Provinces (2022)")

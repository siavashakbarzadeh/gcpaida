"""
Generate an English Word document report for CGP city analysis results (2024).
"""
import os
import pandas as pd
...
def main():
    ...
    doc.add_paragraph(
        ...
        'using CGP on 2024 data from 107 provinces.')
    ...
    doc.add_paragraph('Daily cumulative infections for 107 provinces in 2024 (365 days), merged into merged_cities_2024.csv.')
    ...
    doc.add_paragraph(f'{n_sig} significant connections found among 107 cities in 2024 data.')
    ...
    path = os.path.join(OUTPUT_DIR, 'CGP_Report_English_2024.docx')
    doc.save(path)

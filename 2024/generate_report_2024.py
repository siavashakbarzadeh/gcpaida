"""
Generate a Word document report (Farsi) for CGP city analysis results (2024).
"""
import os
import pandas as pd
...
CGP_DIR = r"c:\Users\Utente\Documents\GitHub\gcpaida\2024\cgp_results"
...
def main():
    ...
    data_desc = (
        ...
        'این داده‌ها از فایل‌های CSV هر شهر استخراج و در یک فایل واحد (merged_cities_2024.csv) ادغام شده‌اند.'
    )
    ...
    output_path = os.path.join(OUTPUT_DIR, 'CGP_Report_Farsi_2024.docx')

"""
SIR Model for ALL 107 Italian Provinces - COVID-19 Data (2024)
===============================================================
Reads merged_cities_2024.csv and applies SIR compartmental model
to all 107 provinces. Results saved to sir-result-2024/ folder.
...
OUTPUT_DIR = r"c:\Users\Utente\Documents\GitHub\gcpaida\2024\sir-result-2024"
os.makedirs(OUTPUT_DIR, exist_ok=True)

# Italian province populations (ISTAT 2024 approximate)
...
def plot_city(city, dates, cumulative, sir_result, beta_t, daily_new, output_dir):
    ...
    fig.suptitle(f'SIR Model - {city.title()} (2024)', fontsize=16, fontweight='bold')
...
def plot_top_cities_comparison(all_results, dates, output_dir, top_n=10):
    ...
    fig.suptitle(f'SIR Model - Top {top_n} Cities by Total Cases (2024)', fontsize=16, fontweight='bold')
...
def plot_all_beta_heatmap(all_results, dates, output_dir):
    ...
    ax.set_title('Beta(t) Heatmap - All 107 Cities (2024)', fontsize=14, fontweight='bold')
    ax.set_xlabel('Month')
...
def main():
    print("=" * 70)
    print("   SIR Model - ALL 107 Italian Provinces (2024)")
    ...
    # Identify all city columns (2024 format: infected_CityName)

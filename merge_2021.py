...
# مسیر پوشه حاوی فایل‌های csv سال 2021
folder_path = r"c:\Users\Utente\Documents\GitHub\gcpaida\2021\2021_city_csv"

# مسیر خروجی در پوشه 2021
output_dir = r"c:\Users\Utente\Documents\GitHub\gcpaida\2021"
...
for file in csv_files:
    ...
    if not df.empty and 'denominazione_provincia' in df.columns:
        ...
        # ساخت نام ستون جدید مثلا infected_Roma
...
output_path = os.path.join(output_dir, "merged_cities_2021.csv")
